# Custom JSONEncoder that casts dict keys to string.
# Some code from original json module was used with changes in
# .iterencode -> _make_iterencode -> _iter_encode -> _iterencode_dict
